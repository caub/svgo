...
var SVGO = module.exports = function(config) {
    ...
    this.js2svg = function(svgjs) { // allows to stringify again after altering svg manually
        return JS2SVG(PLUGINS(svgjs, this.config.plugins), this.config.js2svg);
    }
};
...
SVGO.prototype.optim = SVGO.prototype.optimize = function(svgStr, passes) {
